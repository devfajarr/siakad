...
class UpdateRiwayatPendidikanMahasiswaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_perguruan_tinggi_asal' => [
                'nullable',
                'required_unless:id_jenis_daftar,' . StoreRiwayatPendidikanMahasiswaRequest::JENIS_PESERTA_DIDIK_BARU,
                'string',
            ],
            'id_prodi_asal' => [
                'nullable',
